...
#s(hash-table test equal data ("straight" ("2025-05-30 15:38:01" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2025-05-30 15:38:01" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2025-05-30 15:38:01" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2025-05-30 15:38:01" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2025-05-30 15:38:01" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2025-05-30 15:38:01" nil (:type git :host github :repo "dimitri/el-get" :build nil :files (:defaults "methods" ("recipes" "recipes/el-get.rcp") "el-get-pkg.el") :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2025-05-30 15:38:01" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "use-package" ("2025-05-30 15:38:01" ("emacs" "bind-key") (:type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git")) :package "use-package" :local-repo "use-package")) "bind-key" ("2025-05-30 15:38:01" ("emacs") (:type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git")) :package "bind-key" :local-repo "bind-key")) "magit" ("2025-05-30 15:38:01" ("emacs" "compat" "llama" "magit-section" "seq" "transient" "with-editor") (:type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "compat" ("2025-05-30 15:38:01" ("emacs" "seq") (:type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git")) :package "compat" :local-repo "compat")) "seq" ("2025-05-30 15:38:01" nil (:type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git")) :package "seq" :local-repo "seq")) "llama" ("2025-05-30 15:38:01" ("emacs" "compat") (:type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama" :package "llama" :local-repo "llama")) "magit-section" ("2025-05-30 15:38:01" ("emacs" "compat" "llama" "seq") (:files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :package "magit-section" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2025-05-30 15:38:01" ("emacs" "compat" "seq") (:type git :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2025-05-30 15:38:01" ("emacs" "compat") (:type git :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "evil" ("2025-05-30 15:38:01" ("emacs" "cl-lib" "goto-chg" "nadvice") (:type git :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil" :package "evil" :local-repo "evil")) "goto-chg" ("2025-05-30 15:38:01" ("emacs") (:type git :host github :repo "emacs-evil/goto-chg" :package "goto-chg" :local-repo "goto-chg")) "general" ("2025-05-30 15:24:39" ("emacs" "cl-lib") (:type git :host github :repo "noctuid/general.el" :package "general" :local-repo "general.el")) "corfu" ("2025-05-30 15:24:41" ("emacs" "compat") (:type git :files (:defaults "extensions/corfu-*.el" "corfu-pkg.el") :host github :repo "minad/corfu" :package "corfu" :local-repo "corfu")) "treesit-auto" ("2025-05-30 15:38:01" ("emacs") (:type git :host github :repo "renzmann/treesit-auto" :package "treesit-auto" :local-repo "treesit-auto")) "company-prescient" ("2025-05-30 15:38:01" ("emacs" "prescient" "company") (:type git :files ("company-prescient.el" "company-prescient-pkg.el") :host github :repo "radian-software/prescient.el" :package "company-prescient" :local-repo "prescient.el")) "prescient" ("2025-05-30 15:38:01" ("emacs") (:files ("prescient.el" "prescient-pkg.el") :package "prescient" :local-repo "prescient.el" :type git :repo "radian-software/prescient.el" :host github)) "company" ("2025-05-30 15:38:01" ("emacs") (:type git :files (:defaults "icons" ("images/small" "doc/images/small/*.png") "company-pkg.el") :host github :repo "company-mode/company-mode" :package "company" :local-repo "company-mode"))))
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t) (register-definition-prefixes "bind-key" '("bind-key" "override-global-m")) (provide 'bind-key-autoloads)) "use-package" ((use-package-core use-package-autoloads use-package-jump use-package-diminish use-package-lint use-package use-package-ensure-system-package use-package-ensure use-package-bind-key use-package-delight use-package-pkg) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
(fn SEQUENCE)") (register-definition-prefixes "seq-25" '("seq-")) (provide 'seq-autoloads)) "compat" ((compat-25 compat-27 compat-30 compat-autoloads compat-macs compat-pkg compat-28 compat-26 compat-29 compat) (register-definition-prefixes "compat" '("compat-")) (register-definition-prefixes "compat-macs" '("compat-")) (provide 'compat-autoloads)) "llama" ((\.dir-locals llama llama-autoloads) (autoload 'llama "llama" "Expand to a `lambda' expression that wraps around FN and BODY.
...
(fn COMMAND &optional OUTPUT-BUFFER ERROR-BUFFER ENVVAR)" t) (register-definition-prefixes "with-editor" '("server-" "shell-command" "start-file-process" "with-editor")) (provide 'with-editor-autoloads)) "magit" ((magit-extras magit-gitignore magit-bisect magit-status magit-notes magit-ediff magit-files magit-margin magit-sparse-checkout magit-core magit-pull git-commit magit-subtree magit-fetch magit-reflog magit-sequence magit-patch magit-diff \.dir-locals magit-merge magit-reset magit-bookmark magit-transient magit-submodule magit-worktree magit-clone magit-bundle magit-process magit-refs magit-blame magit-wip magit-dired magit-base magit magit-autoloads magit-mode magit-commit magit-git magit-repos magit-push magit-branch magit-apply magit-stash git-rebase magit-autorevert magit-log magit-tag magit-remote) (put 'git-commit-major-mode 'safe-local-variable (lambda (val) (memq val '(text-mode markdown-mode org-mode fundamental-mode log-edit-mode git-commit-elisp-text-mode)))) (register-definition-prefixes "git-commit" '("git-commit-" "global-git-commit-mode")) (autoload 'git-rebase-current-line "git-rebase" "Parse current line into a `git-rebase-action' instance.
...
(fn WORKTREE PATH)" t) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "goto-chg" ((goto-chg goto-chg-autoloads) (autoload 'goto-last-change "goto-chg" "Go to the point where the last edit was made in the current buffer.
...
(fn &optional SHORT-NAMES _)") (register-definition-prefixes "general" '("general-")) (provide 'general-autoloads)) "corfu" ((corfu-quick corfu corfu-history corfu-indexed corfu-info corfu-autoloads corfu-echo corfu-popupinfo) (autoload 'corfu-mode "corfu" "COmpletion in Region FUnction.
...
(fn FILTER-TYPE KBD-STRING)" nil t) (register-definition-prefixes "prescient" '("prescient-" "selectrum-")) (provide 'prescient-autoloads)) "company" ((company-gtags company-bbdb company-ispell company-files company-etags company-keywords company-autoloads company-tempo company-capf company-semantic company-cmake company company-clang company-dabbrev company-nxml company-abbrev company-oddmuse company-template company-css company-tng company-dabbrev-code company-yasnippet) (autoload 'company-mode "company" "\"complete anything\"; is an in-buffer completion framework.
...
(fn COMMAND &optional ARG &rest IGNORE)" t) (register-definition-prefixes "company-yasnippet" '("company-yasnippet-")) (provide 'company-autoloads)) "company-prescient" ((company-prescient-autoloads company-prescient) (defvar company-prescient-mode nil "Non-nil if Company-Prescient mode is enabled.
...
(fn &optional ARG)" t) (register-definition-prefixes "company-prescient" '("company-prescient-")) (provide 'company-prescient-autoloads))))

#s(hash-table test eq data (org-elpa #s(hash-table test equal data (version 15 "melpa" nil "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "magit" nil "compat" nil "seq" nil "llama" nil "magit-section" nil "transient" nil "with-editor" nil "evil" nil "cl-lib" nil "goto-chg" nil "evil-mode" nil "general" nil "corfu" nil "treesit-auto" nil "company-prescient" nil "prescient" nil "company" nil)) melpa #s(hash-table test equal data (version 2 "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" (el-get :type git :files (:defaults "methods" ("recipes" "recipes/el-get.rcp") "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "magit" (magit :type git :files ("lisp/magit*.el" "lisp/git-*.el" "docs/magit.texi" "docs/AUTHORS.md" "LICENSE" ".dir-locals.el" (:exclude "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit") "compat" nil "seq" nil "llama" (llama :type git :files ("llama.el" ".dir-locals.el" "llama-pkg.el") :host github :repo "tarsius/llama") "magit-section" (magit-section :type git :files ("lisp/magit-section.el" "docs/magit-section.texi" "magit-section-pkg.el" "magit-section-pkg.el") :host github :repo "magit/magit") "transient" (transient :type git :host github :repo "magit/transient") "with-editor" (with-editor :type git :host github :repo "magit/with-editor") "evil" (evil :type git :files (:defaults "doc/build/texinfo/evil.texi" (:exclude "evil-test-helpers.el") "evil-pkg.el") :host github :repo "emacs-evil/evil") "cl-lib" nil "goto-chg" (goto-chg :type git :host github :repo "emacs-evil/goto-chg") "evil-mode" nil "general" (general :type git :host github :repo "noctuid/general.el") "corfu" (corfu :type git :files (:defaults "extensions/corfu-*.el" "corfu-pkg.el") :host github :repo "minad/corfu") "treesit-auto" (treesit-auto :type git :host github :repo "renzmann/treesit-auto") "company-prescient" (company-prescient :type git :files ("company-prescient.el" "company-prescient-pkg.el") :host github :repo "radian-software/prescient.el") "prescient" (prescient :type git :files ("prescient.el" "prescient-pkg.el") :host github :repo "radian-software/prescient.el") "company" (company :type git :files (:defaults "icons" ("images/small" "doc/images/small/*.png") "company-pkg.el") :host github :repo "company-mode/company-mode"))) gnu-elpa-mirror #s(hash-table test equal data (version 3 "nongnu-elpa" nil "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :host github :repo "emacs-straight/use-package" :files ("*" (:exclude ".git"))) "bind-key" (bind-key :type git :host github :repo "emacs-straight/bind-key" :files ("*" (:exclude ".git"))) "compat" (compat :type git :host github :repo "emacs-straight/compat" :files ("*" (:exclude ".git"))) "seq" (seq :type git :host github :repo "emacs-straight/seq" :files ("*" (:exclude ".git"))) "cl-lib" nil "evil-mode" nil)) nongnu-elpa #s(hash-table test equal data (version 4 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "evil-mode" nil)) el-get #s(hash-table test equal data (version 2 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "evil-mode" nil)) emacsmirror-mirror #s(hash-table test equal data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "cl-lib" nil "evil-mode" nil))))

("company" "prescient" "company-prescient" "treesit-auto" "with-editor" "transient" "magit-section" "llama" "seq" "compat" "magit" "nadvice" "goto-chg" "cl-lib" "evil" "bind-key" "use-package" "emacs" "straight" "emacsmirror-mirror" "el-get" "nongnu-elpa" "gnu-elpa-mirror" "melpa" "org-elpa")
